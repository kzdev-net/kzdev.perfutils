...
namespace MemoryStreamProfile
{
    internal static class FillProfile
    {
        public static void RunProfile (string[] args)
        {
            ...
            {
                Console.WriteLine($@"Running {fillTest.GetType().Name}.{nameof(BulkFillAndReadThroughputBenchmarks.UseMemoryStream)}");
            ...
            {
                Console.WriteLine($@"Running {fillTest.GetType().Name}.{nameof(BulkFillAndReadThroughputBenchmarks.UseRecyclableMemoryStream)}");
                // Run through once to warm things up.
            ...
            {
                Console.WriteLine($@"Running {fillTest.GetType().Name}.{nameof(BulkFillAndReadThroughputBenchmarks.UseMemoryStreamSlim)}");
                // Run through once to warm things up.
